...
#  elif defined(VGO_freebsd)
   static HChar *filedesc_buf = NULL;
   ...
   if (filedesc_buf == NULL)    // first time
      filedesc_buf = VG_(malloc)("resolve_filename", len);
...
#     define GETCWD_ERANGE VKI_ENOMEM
#  else
#     define GETCWD_ERANGE VKI_ERANGE
#  endif
   ...
   } while (sr_isError(res) && sr_Err(res) == GETCWD_ERANGE);
...
#  elif defined(VGP_amd64_linux) || defined(VGP_arm_linux) \
        ...
        || defined(VGO_freebsd) || defined(VGP_tilegx_linux)
   SysRes res;
